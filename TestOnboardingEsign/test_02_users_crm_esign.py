...
def test_get_oppourtunity_id_by_application_id():
    get_opportunity_id_response = helper_functions.get_oppourtunity_id_by_application_id(BASE_URL, CRM_TOKEN,ONBOARDING_TOKEN, APPLICATION_NAME)
...
def test_do_action_rq():
    ...
    # print(get_do_action_rq_response[0])
